...
public abstract class ScaleImageUtils {
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        ...
        System.out.println(ScaleImageUtils.resize(104, 64, null, new URL("http://192.168.11.240:8080/TQZ/fuxiao/images/xiao1.jpg")));

        ScaleImageUtils.resize(104, 64, ImageQuality.high.getQuality(), null, ImageIO.read(new URL("http://192.168.11.240:8080/TQZ/fuxiao/images/xiao1.jpg")));
