...
/*	    System.out.println( "Shared Random" );
	    testRandom(THREADS, COUNT);*/	//无重复
/*	    System.out.println("ThreadLocal<Random>"); 
		testTL_Random(THREADS, COUNT);*/  // 有重复
/*		System.out.println("ThreadLocalRandom");
		testTLRandom(THREADS, COUNT);*/ //无重复
	...
	private static class RandomTask implements Runnable
	{
	    ...
	    public void run() {
	        try {
	            ...
	            System.out.println( "Thread #" + id + " Time = " + time / 1000.0 + " sec, sum = " + sum + ", type : " + r + ", start:" + start);
